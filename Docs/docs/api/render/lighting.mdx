...
All five light components are editable in the Nuklear debug UI inspector. Select a light entity in the Scene panel to view and modify its properties in real time.

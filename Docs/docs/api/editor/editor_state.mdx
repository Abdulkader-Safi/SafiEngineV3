...
The `gltf_viewer` demo maps **F1** to toggle Edit ↔ Play. In Edit mode the falling cube freezes mid-air; flip back to Play and it resumes. This exercises the pipeline gate described in [Scheduler](../core/scheduler).
